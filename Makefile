...
VPATH = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3
am__make_dryrun = \
  { \
    am__dry=no; \
    case $$MAKEFLAGS in \
...
am__append_1 = tests 
#am__append_2 = tests
am__append_3 = gio-unix-2.0.pc
#am__append_4 = gio-windows-2.0.pc
subdir = .
...
am__installdirs = "$(DESTDIR)$(bindir)" "$(DESTDIR)$(gettextdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
SCRIPTS = $(bin_SCRIPTS) $(gettext_SCRIPTS)
AM_V_P = $(am__v_P_$(V))
...
ACLOCAL = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/missing --run aclocal-1.12
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/missing --run autoconf
AUTOHEADER = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/missing --run autoheader
AUTOMAKE = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/missing --run automake-1.12
AWK = gawk
...
LIBELF_CFLAGS = 
LIBELF_LIBS = 
LIBFFI_CFLAGS = -I/dtv/spt/jeongseok.kim/work/gst_x86/pioneer/lib/libffi-3.0.12/include  
LIBFFI_LIBS = -L/dtv/spt/jeongseok.kim/work/gst_x86/pioneer/lib -lffi  
LIBOBJS = 
LIBS =  
...
LT_REVISION = 3
MAINT = 
MAKEINFO = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MKINSTALLDIRS = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/mkinstalldirs
...
PACKAGE_NAME = glib
PACKAGE_STRING = glib 2.34.3
PACKAGE_TARNAME = glib
PACKAGE_URL = 
PACKAGE_VERSION = 2.34.3
PATH_SEPARATOR = :
PCRE_CFLAGS = 
PCRE_LIBS = 
PCRE_REQUIRES = 
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /dtv/spt/jeongseok.kim/work/gst_x86/pioneer/lib/pkgconfig
PLATFORMDEP = 
...
ZLIB_CFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /dtv/spt/jeongseok.kim/work/gst-lge-build
abs_srcdir = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3
abs_top_builddir = /dtv/spt/jeongseok.kim/work/gst-lge-build
abs_top_srcdir = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = c++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3/install-sh
libdir = ${exec_prefix}/lib
libexecdir = ${exec_prefix}/libexec
localedir = /dtv/spt/jeongseok.kim/work/gst_x86/pioneer/share/locale
...
pkgpyexecdir = 
pkgpythondir = 
prefix = /dtv/spt/jeongseok.kim/work/gst_x86/pioneer
...
srcdir = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3
sysconfdir = ${prefix}/etc
target_alias = 
top_build_prefix = 
top_builddir = .
top_srcdir = /dtv/spt/jeongseok.kim/work/gst-lge-build/unpack/glib-2.34.3
...
EXTRA_DIST = ChangeLog.pre-2-20 ChangeLog.pre-2-18 ChangeLog.pre-2-16 \
	...
	README.in INSTALL.in README.win32 HACKING autogen.sh \
	Makefile.decl mkinstalldirs makefile.msc \
...
pkgconfig_DATA = glib-2.0.pc gobject-2.0.pc gmodule-2.0.pc \
	...
	gio-2.0.pc $(am__append_3) $(am__append_4)
...
install-gettextSCRIPTS: $(gettext_SCRIPTS)
	@$(NORMAL_INSTALL)
	@list='$(gettext_SCRIPTS)'; test -n "$(gettextdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(gettextdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(gettextdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  if test -f "$$d$$p"; then echo "$$d$$p"; echo "$$p"; else :; fi; \
	...
	while read type dir files; do \
	     if test "$$dir" = .; then dir=; else dir=/$$dir; fi; \
	     test -z "$$files" || { \
	       echo " $(INSTALL_SCRIPT) $$files '$(DESTDIR)$(gettextdir)$$dir'"; \
	       $(INSTALL_SCRIPT) $$files "$(DESTDIR)$(gettextdir)$$dir" || exit $$?; \
	     } \
	; done

uninstall-gettextSCRIPTS:
	@$(NORMAL_UNINSTALL)
	@list='$(gettext_SCRIPTS)'; test -n "$(gettextdir)" || exit 0; \
	files=`for p in $$list; do echo "$$p"; done | \
	       sed -e 's,.*/,,;$(transform)'`; \
	dir='$(DESTDIR)$(gettextdir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(gettextdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-gettextSCRIPTS install-pkgconfigDATA
...
uninstall-am: uninstall-binSCRIPTS uninstall-gettextSCRIPTS \
	uninstall-pkgconfigDATA
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-exec install-exec-am install-gettextSCRIPTS \
	...
	uninstall-gettextSCRIPTS uninstall-pkgconfigDATA
