...
//2013-03-27 gstreamer upgrade start
	//sungeol.baek
  gst_caps_set_simple (caps,
    "format", GST_FOURCC_FORMAT, GST_FOURCC_ARGS (codec_fcc), NULL);
...
//2013-03-27 gstreamer upgrade start
#ifdef INCLUDE_LMF	// Increase max channel 6 to 8 for 7.1 wma channel file (Requested by meeshel)
      channels_max = 8;
#else
      channels_max = 6;
#endif
...
//2013-03-27 gstreamer upgrade start
    gst_caps_set_simple (caps,
	  ...
	  "channels", G_TYPE_INT, strf->channels,
	  "rate", G_TYPE_INT, strf->rate,
	  "byterate", G_TYPE_INT, strf->av_bps,
	  "block_align", G_TYPE_INT, strf->blockalign,
	  "depth", G_TYPE_INT, strf->bits_per_sample,
	  NULL);
//2013-03-27 gstreamer upgrade end
