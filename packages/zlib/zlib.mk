...
all: extract
	...
	cmake -DCMAKE_INSTALL_PREFIX=$(PLATFORM_STAGING_DIR) \
		-DINSTALL_PREFIX=$(PLATFORM_STAGING_DIR) \
		-DINSTALL_PKGCONFIG_DIR=$(PLATFORM_STAGING_DIR)/lib/pkgconfig \
		-DCMAKE_TOOLCHAIN_FILE=$(PKG_DIR)/$(ZLIB_NAME)/crosscompile.cmake \
		-DPLATFORM_CHIP=$(PLATFORM_CHIP) \
		-DTARGET_PLATFORM_NAME=$(TARGET_PLATFORM_NAME) \
